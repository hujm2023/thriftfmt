...
struct Typedef {
    ...
    5: string ReservedEndLineComments
}
...
struct Field {
    ...
    8: string ReservedEndLineComments
}
...
struct StructLike {
    ...
    4: Annotations Annotations
    5: string ReservedComments
    6: string ReservedEndLineComments
}
...
struct Function {
    ...
    9: string ReservedEndLineComments
}
...
struct Service {
    ...
    7: string ReservedEndLineComments
}
